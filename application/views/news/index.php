  ...
  <div class="table-wrapper">
    <div class="table-title">
      <div class="row">
          ...
          <div class="col-sm-6">
            <a href="<?php echo base_url(); ?>news/create" class="btn btn-success">Add News</a>		
      ...
      <tbody>
        <?php  
          foreach ($news as $new) {
            ...
            echo '<td>'.$new->datePublication.'</td>';
            echo '<td>'.$new->idState.'</td>';
            echo '<td>'.$new->idState.'</td>';
            echo '<td><a class="btn btn-primary" href="news/edit/'.$new->idNews.'">Edit</a>'.form_open('/news/delete/'.$new->idNews).'<input type="submit" value="Delete" class="btn btn-danger"></form></td>';
            echo "</tr>";
          } 
        ?>
        <!--
